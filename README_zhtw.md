...
| `AGENT_BUSINESS_ANALYSIS_WORKSPACE_DIR` | ❌ | `/app/data/reports` | 報告輸出目錄 |
...
額外的 MCP 可從 **CoStaff Dashboard** 動態指派：`Agents → costaff-agent-business-analysis → MCP Extensions → Apply & Restart`，無需重新部署。
